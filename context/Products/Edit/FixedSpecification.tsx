...
const FixedSpecification = ({
  ...
  useEffect(() => {
    for (const fixedSpecification of fixedSpecifications) {
      if (
        fixedSpecification.label === spec.nameFa &&
        !Array.isArray(fixedSpecification.values)
      ) {
        setInputValue(fixedSpecification.values);
      }
    }
